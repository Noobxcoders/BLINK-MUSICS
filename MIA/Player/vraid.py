...
from MIA.inline import stream_markup
...
from MIA.main import bot as MIA, Test
...
IMAGE_THUMBNAIL = "https://te.legra.ph/file/7ed99cd565dbda1564266.jpg"
HNDLR = '/'
...
@MIA.on_message(filters.user(SUDO_USERS) & filters.command(["videoraid", "vraid"], prefixes=HNDLR))
async def vraid(c: MIA, m: Message):
    await m.delete()
