...
from MIA.data import RAID, REPLYRAID, DEADLYSPAM
from MIA.main import BOT
...
LOVEOP = [
   ...
   "KYU TUMHARE ANKHEN ITNI SUNDAR HAIN🥺",
    ...
    "PATA NAI MERE DOST TUMHE SUBAH SE JIJU BOL RAHE HAIN SAYAD UNHE HUMARE BARE PATA CHAL GAYA😍",
    "JAAN SE JYADA TUM PYAR HO BABY🥺",
    "KYA MATLAB TUM MERA HO GAYE  HO🥺",
    "MERE BACCHON KI PAPA BANOGA 🥺",
    "TUNE MERI ZINGADI BANA DI🥺",
    "KYA MATLAB HUM SHADI KAR RAHE HAIN 😍",
    "BABY TUM NA MILA TOH ME FIRSE TRY KARUNGI 😏",
    ...
    "AGAR TUM CHALI GAYE TOH MERA KYA HOGA🥺",
